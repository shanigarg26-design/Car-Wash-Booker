...
// Read-only informational map (web / iframe variant). Mirrors the native
// component: a fixed marker at the given coordinates, pan/zoom only.
...
const styles = StyleSheet.create({
  container: { flex: 1 },
  mapWrap: { flex: 1, backgroundColor: '#0A1628' },
  loadingOverlay: {
